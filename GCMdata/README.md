Future climate data were obtained from the CMIP6 suite of generalize circulation models (GCMs), downscaled and bias-corrected by the Inter-Sectoral Model Intercomparison Project (ISI-MIP). 
